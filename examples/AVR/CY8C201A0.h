...
/*
 * Writes data to CY8C201 - signle location
 */
void CY8_WrSingle( unsigned short wAddr,
                   unsigned short wData );

/*
 * Reads data from  CY8C201 - single location (random)
 */
unsigned short CY8_RdSingle( unsigned short rAddr );

/*
 * Writes data to  CY8C201 - sequential write
 */
...
/*
 * Reads data from  CY8C201 - sequential read
 */
